...
namespace House.Infrastructure.Migrations
{
    ...
    [Migration("20230912203847_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("House.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.HasIndex(new[] { "LocationId" }, "IX_Apartments_LocationId");
            ...
            modelBuilder.Entity("House.Domain.Entities.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("House.Domain.Entities.Owner", b =>
                {
                    ...
                    b.HasIndex(new[] { "LocationId" }, "IX_Owners_LocationId");
            ...
            modelBuilder.Entity("House.Domain.Entities.Apartment", b =>
                {
                    b.HasOne("House.Domain.Entities.Location", "Location")
                        .WithMany("Apartments")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_Apartments_Location");
            ...
            modelBuilder.Entity("House.Domain.Entities.Owner", b =>
                {
                    b.HasOne("House.Domain.Entities.Location", "Location")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Owners_Location");
