...
using House.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using House.Application.TodoLists.Queries.GetTodos;
using House.Domain.Entities;
using NUnit.Framework;

namespace House.Application.UnitTests.Common.Mappings;
